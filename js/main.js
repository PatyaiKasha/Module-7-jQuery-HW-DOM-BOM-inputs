...
$('#num-of-h').on('click', function(event) {
    ...
    if ($('h1').length <= 0) {
        $('#hh').append('Тэг "h1" отсутсвует на странице<br>');
    } else {
        $('#hh').append($('h1').length + ' тэгов "h1" на странице<br>');
    }
    if ($('h2').length <= 0) {
        $('#hh').append('Тэг "h2" отсутсвует на странице<br>');
    } else {
        $('#hh').append($('h2').length + ' тэгов "h2" на странице<br>');
    }
    if ($('h3').length <= 0) {
        $('#hh').append('Тэг "h3" отсутсвует на странице<br>');
    } else {
        $('#hh').append($('h3').length + ' тэгов "h3" на странице<br>');
    }
    if ($('h4').length <= 0) {
        $('#hh').append('Тэг "h4" отсутсвует на странице<br>');
    } else {
        $('#hh').append($('h4').length + ' тэгов "h4" на странице<br>');
    }
    if ($('h5').length <= 0) {
        $('#hh').append('Тэг "h5" отсутсвует на странице<br>');
    } else {
        $('#hh').append($('h5').length + ' тэгов "h5" на странице<br>');
    }
    if ($('h6').length <= 0) {
        $('#hh').append('Тэг "h6" отсутсвует на странице<br>');
    } else {
        $('#hh').append($('h6').length + ' тэгов "h6" на странице<br>');
    }
});
